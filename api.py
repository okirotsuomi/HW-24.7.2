...
class PetFriends:
    ...
    def add_new_pet_without_photo_with_unvalid_auth_key(self, auth_key: json, name: str,
                                  animal_type: str, age: str) -> json:
        """Метод отправляет на сервер данные о добавляемом питомце без фото и с невалидным ключом."""
        ...
        headers = {'unvalid_auth_key': auth_key['key'], 'Content-Type': data.content_type}
    ...
    def get_list_of_pets_with_unvalid_auth_key(self, auth_key: json, filter: str = "") -> json:
        """Метод делает проверочный запрос с невалидным ключом к API сервера. На данный момент фильтр может иметь
        либо пустое значение - получить список всех питомцев, либо 'my_pets' - получить список
        собственных питомцев"""

        headers = {'unvalid_auth_key': auth_key['key']}
        filter = {'filter': filter}
    ...
    def add_new_pet_with_incorrect_auth_key(self, auth_key: json, name: str, animal_type: str,
                    age: str, pet_photo: str) -> json:
        """Метод отправляет на сервер данные о добавляемом питомце с невалидным ключом"""
    ...
    def add_photo_of_pet_with_unvalid_auth_key(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет на сервер фото с невалидным ключом к добавленному ранее питомцу."""
